...
define(function() {
   ...
   *   "authorKey"       => "author"
   */
  inflection.humanize = function (word) {
    ...
    return inflection.split(word, " ").toLowerCase();
  }

  /**
   * Split a camel case word in its terms.
   */
  inflection.split = function (word, delim) {
    delim = delim || " ";
   ...
   */
  inflection.underscore = function (word) {
    return inflection.split(word, "_").toLowerCase();
  }

  /**
   * Converts a CamelCase word to dash (lisp style) format.
   */
  inflection.dash = inflection.dasherize = function (word) {
    return inflection.split(word, "-").toLowerCase();
  }
